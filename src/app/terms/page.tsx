...
async function fetchTerms(): Promise<LegalDocument | null> {
  try {
    const res = await fetch(`${API_BASE_URL}/legal/terms`, {
...
export const metadata = {
  title: "Términos y Condiciones · Ushuaia360",
  description: "Términos y condiciones de la aplicación Ushuaia360.",
};

export default async function TermsPage() {
  const doc = await fetchTerms();
          ...
          {doc?.content ? (
            ...
            <div className="flex flex-col items-center gap-4 py-12 text-center">
              ...
              <p className="text-sm font-light text-gray-500">
                No se pudieron cargar los términos y condiciones. Intentá de nuevo más tarde.
              </p>
            </div>
          ) : (
            <div className="flex flex-col items-center gap-4 py-12 text-center">
